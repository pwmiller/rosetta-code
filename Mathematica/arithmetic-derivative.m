(* rosettacode URL: https://rosettacode.org/wiki/Arithmetic_derivative#Mathematica_/_Wolfram_Language *)

ClearAll[d, twoFactorsOf];

twoFactorsOf[n_Integer?Positive] := Module[
    {factors = FactorInteger[n, 2], p, factor},
